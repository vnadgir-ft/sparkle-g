// $ANTLR 3.4 com\\googlecode\\sparkleg\\Sparql.g 2011-11-18 18:28:58
...
public class SparqlLexer extends Lexer {
    ...
    public final void mWS() throws RecognitionException {
        try {
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:687:4: ( ( ' ' | '\\t' | EOL )+ )
            // com\\googlecode\\sparkleg\\Sparql.g:687:6: ( ' ' | '\\t' | EOL )+
            {
            // com\\googlecode\\sparkleg\\Sparql.g:687:6: ( ' ' | '\\t' | EOL )+
            int cnt1=0;
            loop1:
    ...
    public final void mBASE() throws RecognitionException {
        try {
            int _type = BASE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:689:6: ( ( 'B' | 'b' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:689:8: ( 'B' | 'b' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' )
            {
    ...
    public final void mPREFIX() throws RecognitionException {
        try {
            int _type = PREFIX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:691:8: ( ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'X' | 'x' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:691:10: ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'X' | 'x' )
            {
    ...
    public final void mSELECT() throws RecognitionException {
        try {
            int _type = SELECT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:693:8: ( ( 'S' | 's' ) ( 'E' | 'e' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'C' | 'c' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:693:10: ( 'S' | 's' ) ( 'E' | 'e' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'C' | 'c' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDISTINCT() throws RecognitionException {
        try {
            int _type = DISTINCT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:695:10: ( ( 'D' | 'd' ) ( 'I' | 'i' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:695:12: ( 'D' | 'd' ) ( 'I' | 'i' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'T' | 't' )
            {
    ...
    public final void mREDUCED() throws RecognitionException {
        try {
            int _type = REDUCED;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:697:9: ( ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'D' | 'd' ) ( 'U' | 'u' ) ( 'C' | 'c' ) ( 'E' | 'e' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:697:11: ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'D' | 'd' ) ( 'U' | 'u' ) ( 'C' | 'c' ) ( 'E' | 'e' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='R'||input.LA(1)=='r' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCONSTRUCT() throws RecognitionException {
        try {
            int _type = CONSTRUCT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:699:11: ( ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'C' | 'c' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:699:13: ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'C' | 'c' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDESCRIBE() throws RecognitionException {
        try {
            int _type = DESCRIBE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:701:10: ( ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'S' | 's' ) ( 'C' | 'c' ) ( 'R' | 'r' ) ( 'I' | 'i' ) ( 'B' | 'b' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:701:12: ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'S' | 's' ) ( 'C' | 'c' ) ( 'R' | 'r' ) ( 'I' | 'i' ) ( 'B' | 'b' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mASK() throws RecognitionException {
        try {
            int _type = ASK;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:703:5: ( ( 'A' | 'a' ) ( 'S' | 's' ) ( 'K' | 'k' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:703:7: ( 'A' | 'a' ) ( 'S' | 's' ) ( 'K' | 'k' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mFROM() throws RecognitionException {
        try {
            int _type = FROM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:705:6: ( ( 'F' | 'f' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'M' | 'm' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:705:8: ( 'F' | 'f' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'M' | 'm' )
            {
            if ( input.LA(1)=='F'||input.LA(1)=='f' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mNAMED() throws RecognitionException {
        try {
            int _type = NAMED;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:707:7: ( ( 'N' | 'n' ) ( 'A' | 'a' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:707:9: ( 'N' | 'n' ) ( 'A' | 'a' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='N'||input.LA(1)=='n' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mWHERE() throws RecognitionException {
        try {
            int _type = WHERE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:709:7: ( ( 'W' | 'w' ) ( 'H' | 'h' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:709:9: ( 'W' | 'w' ) ( 'H' | 'h' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'E' | 'e' )
            {
    ...
    public final void mORDER() throws RecognitionException {
        try {
            int _type = ORDER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:711:7: ( ( 'O' | 'o' ) ( 'R' | 'r' ) ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:711:9: ( 'O' | 'o' ) ( 'R' | 'r' ) ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='O'||input.LA(1)=='o' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mBY() throws RecognitionException {
        try {
            int _type = BY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:713:4: ( ( 'B' | 'b' ) ( 'Y' | 'y' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:713:6: ( 'B' | 'b' ) ( 'Y' | 'y' )
            {
            if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mASC() throws RecognitionException {
        try {
            int _type = ASC;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:715:5: ( ( 'A' | 'a' ) ( 'S' | 's' ) ( 'C' | 'c' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:715:7: ( 'A' | 'a' ) ( 'S' | 's' ) ( 'C' | 'c' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDESC() throws RecognitionException {
        try {
            int _type = DESC;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:717:6: ( ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'S' | 's' ) ( 'C' | 'c' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:717:8: ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'S' | 's' ) ( 'C' | 'c' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mLIMIT() throws RecognitionException {
        try {
            int _type = LIMIT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:719:7: ( ( 'L' | 'l' ) ( 'I' | 'i' ) ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:719:9: ( 'L' | 'l' ) ( 'I' | 'i' ) ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='L'||input.LA(1)=='l' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mOFFSET() throws RecognitionException {
        try {
            int _type = OFFSET;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:721:8: ( ( 'O' | 'o' ) ( 'F' | 'f' ) ( 'F' | 'f' ) ( 'S' | 's' ) ( 'E' | 'e' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:721:10: ( 'O' | 'o' ) ( 'F' | 'f' ) ( 'F' | 'f' ) ( 'S' | 's' ) ( 'E' | 'e' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='O'||input.LA(1)=='o' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mOPTIONAL() throws RecognitionException {
        try {
            int _type = OPTIONAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:723:10: ( ( 'O' | 'o' ) ( 'P' | 'p' ) ( 'T' | 't' ) ( 'I' | 'i' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'A' | 'a' ) ( 'L' | 'l' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:723:12: ( 'O' | 'o' ) ( 'P' | 'p' ) ( 'T' | 't' ) ( 'I' | 'i' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'A' | 'a' ) ( 'L' | 'l' )
            {
            if ( input.LA(1)=='O'||input.LA(1)=='o' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mGRAPH() throws RecognitionException {
        try {
            int _type = GRAPH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:725:7: ( ( 'G' | 'g' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'P' | 'p' ) ( 'H' | 'h' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:725:9: ( 'G' | 'g' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'P' | 'p' ) ( 'H' | 'h' )
            {
    ...
    public final void mUNION() throws RecognitionException {
        try {
            int _type = UNION;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:727:7: ( ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'I' | 'i' ) ( 'O' | 'o' ) ( 'N' | 'n' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:727:9: ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'I' | 'i' ) ( 'O' | 'o' ) ( 'N' | 'n' )
            {
            if ( input.LA(1)=='U'||input.LA(1)=='u' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mFILTER() throws RecognitionException {
        try {
            int _type = FILTER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:729:8: ( ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'L' | 'l' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:729:10: ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'L' | 'l' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='F'||input.LA(1)=='f' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mA() throws RecognitionException {
        try {
            int _type = A;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:731:3: ( 'a' )
            // com\\googlecode\\sparkleg\\Sparql.g:731:5: 'a'
            {
    ...
    public final void mSTR() throws RecognitionException {
        try {
            int _type = STR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:733:5: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:733:7: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mLANG() throws RecognitionException {
        try {
            int _type = LANG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:735:6: ( ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'G' | 'g' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:735:8: ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'G' | 'g' )
            {
            if ( input.LA(1)=='L'||input.LA(1)=='l' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mLANGMATCHES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:737:13: ( ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'G' | 'g' ) ( 'M' | 'm' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'C' | 'c' ) ( 'H' | 'h' ) ( 'E' | 'e' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:737:15: ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'G' | 'g' ) ( 'M' | 'm' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'C' | 'c' ) ( 'H' | 'h' ) ( 'E' | 'e' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='L'||input.LA(1)=='l' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDATATYPE() throws RecognitionException {
        try {
            int _type = DATATYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:739:10: ( ( 'D' | 'd' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'Y' | 'y' ) ( 'P' | 'p' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:739:12: ( 'D' | 'd' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'Y' | 'y' ) ( 'P' | 'p' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mBOUND() throws RecognitionException {
        try {
            int _type = BOUND;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:741:7: ( ( 'B' | 'b' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:741:9: ( 'B' | 'b' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSAMETERM() throws RecognitionException {
        try {
            int _type = SAMETERM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:743:10: ( ( 'S' | 's' ) ( 'A' | 'a' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'M' | 'm' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:743:12: ( 'S' | 's' ) ( 'A' | 'a' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'M' | 'm' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mISIRI() throws RecognitionException {
        try {
            int _type = ISIRI;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:745:7: ( ( 'I' | 'i' ) ( 'S' | 's' ) ( 'I' | 'i' ) ( 'R' | 'r' ) ( 'I' | 'i' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:745:9: ( 'I' | 'i' ) ( 'S' | 's' ) ( 'I' | 'i' ) ( 'R' | 'r' ) ( 'I' | 'i' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mISURI() throws RecognitionException {
        try {
            int _type = ISURI;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:747:7: ( ( 'I' | 'i' ) ( 'S' | 's' ) ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'I' | 'i' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:747:9: ( 'I' | 'i' ) ( 'S' | 's' ) ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'I' | 'i' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mISBLANK() throws RecognitionException {
        try {
            int _type = ISBLANK;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:749:9: ( ( 'I' | 'i' ) ( 'S' | 's' ) ( 'B' | 'b' ) ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'K' | 'k' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:749:11: ( 'I' | 'i' ) ( 'S' | 's' ) ( 'B' | 'b' ) ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'K' | 'k' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mISLITERAL() throws RecognitionException {
        try {
            int _type = ISLITERAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:751:11: ( ( 'I' | 'i' ) ( 'S' | 's' ) ( 'L' | 'l' ) ( 'I' | 'i' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'L' | 'l' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:751:13: ( 'I' | 'i' ) ( 'S' | 's' ) ( 'L' | 'l' ) ( 'I' | 'i' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'L' | 'l' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mREGEX() throws RecognitionException {
        try {
            int _type = REGEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:753:7: ( ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'G' | 'g' ) ( 'E' | 'e' ) ( 'X' | 'x' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:753:9: ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'G' | 'g' ) ( 'E' | 'e' ) ( 'X' | 'x' )
            {
            if ( input.LA(1)=='R'||input.LA(1)=='r' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSUBSTR() throws RecognitionException {
        try {
            int _type = SUBSTR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:755:8: ( ( 'S' | 's' ) ( 'U' | 'u' ) ( 'B' | 'b' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:755:10: ( 'S' | 's' ) ( 'U' | 'u' ) ( 'B' | 'b' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mTRUE() throws RecognitionException {
        try {
            int _type = TRUE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:757:6: ( ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:757:8: ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='T'||input.LA(1)=='t' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mFALSE() throws RecognitionException {
        try {
            int _type = FALSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:759:7: ( ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:759:9: ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'S' | 's' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='F'||input.LA(1)=='f' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mLOAD() throws RecognitionException {
        try {
            int _type = LOAD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:761:6: ( ( 'L' | 'l' ) ( 'O' | 'o' ) ( 'A' | 'a' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:761:8: ( 'L' | 'l' ) ( 'O' | 'o' ) ( 'A' | 'a' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='L'||input.LA(1)=='l' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCLEAR() throws RecognitionException {
        try {
            int _type = CLEAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:763:7: ( ( 'C' | 'c' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'A' | 'a' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:763:9: ( 'C' | 'c' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'A' | 'a' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDROP() throws RecognitionException {
        try {
            int _type = DROP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:765:6: ( ( 'D' | 'd' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'P' | 'p' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:765:8: ( 'D' | 'd' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'P' | 'p' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mADD() throws RecognitionException {
        try {
            int _type = ADD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:767:5: ( ( 'A' | 'a' ) ( 'D' | 'd' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:767:7: ( 'A' | 'a' ) ( 'D' | 'd' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mMOVE() throws RecognitionException {
        try {
            int _type = MOVE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:769:6: ( ( 'M' | 'm' ) ( 'O' | 'o' ) ( 'V' | 'v' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:769:8: ( 'M' | 'm' ) ( 'O' | 'o' ) ( 'V' | 'v' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='M'||input.LA(1)=='m' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCOPY() throws RecognitionException {
        try {
            int _type = COPY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:771:6: ( ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'P' | 'p' ) ( 'Y' | 'y' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:771:8: ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'P' | 'p' ) ( 'Y' | 'y' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCREATE() throws RecognitionException {
        try {
            int _type = CREATE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:773:9: ( ( 'C' | 'c' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:773:11: ( 'C' | 'c' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDELETE() throws RecognitionException {
        try {
            int _type = DELETE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:775:8: ( ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'T' | 't' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:775:10: ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'T' | 't' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mINSERT() throws RecognitionException {
        try {
            int _type = INSERT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:777:8: ( ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'S' | 's' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:777:10: ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'S' | 's' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mUSING() throws RecognitionException {
        try {
            int _type = USING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:779:7: ( ( 'U' | 'u' ) ( 'S' | 's' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'G' | 'g' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:779:9: ( 'U' | 'u' ) ( 'S' | 's' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'G' | 'g' )
            {
            if ( input.LA(1)=='U'||input.LA(1)=='u' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSILENT() throws RecognitionException {
        try {
            int _type = SILENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:781:8: ( ( 'S' | 's' ) ( 'I' | 'i' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'N' | 'n' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:781:10: ( 'S' | 's' ) ( 'I' | 'i' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'N' | 'n' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDEFAULT() throws RecognitionException {
        try {
            int _type = DEFAULT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:783:9: ( ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'U' | 'u' ) ( 'L' | 'l' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:783:11: ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'U' | 'u' ) ( 'L' | 'l' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mALL() throws RecognitionException {
        try {
            int _type = ALL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:785:5: ( ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'L' | 'l' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:785:7: ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'L' | 'l' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDATA() throws RecognitionException {
        try {
            int _type = DATA;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:787:6: ( ( 'D' | 'd' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'A' | 'a' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:787:8: ( 'D' | 'd' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'A' | 'a' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mWITH() throws RecognitionException {
        try {
            int _type = WITH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:789:6: ( ( 'W' | 'w' ) ( 'I' | 'i' ) ( 'T' | 't' ) ( 'H' | 'h' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:789:8: ( 'W' | 'w' ) ( 'I' | 'i' ) ( 'T' | 't' ) ( 'H' | 'h' )
            {
            if ( input.LA(1)=='W'||input.LA(1)=='w' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mINTO() throws RecognitionException {
        try {
            int _type = INTO;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:791:6: ( ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'T' | 't' ) ( 'O' | 'o' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:791:8: ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'T' | 't' ) ( 'O' | 'o' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mTO() throws RecognitionException {
        try {
            int _type = TO;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:793:4: ( ( 'T' | 't' ) ( 'O' | 'o' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:793:6: ( 'T' | 't' ) ( 'O' | 'o' )
            {
            if ( input.LA(1)=='T'||input.LA(1)=='t' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mAS() throws RecognitionException {
        try {
            int _type = AS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:795:4: ( ( 'A' | 'a' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:795:6: ( 'A' | 'a' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mGROUP() throws RecognitionException {
        try {
            int _type = GROUP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:797:7: ( ( 'G' | 'g' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'P' | 'p' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:797:9: ( 'G' | 'g' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'P' | 'p' )
            {
            if ( input.LA(1)=='G'||input.LA(1)=='g' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mHAVING() throws RecognitionException {
        try {
            int _type = HAVING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:799:8: ( ( 'H' | 'h' ) ( 'A' | 'a' ) ( 'V' | 'v' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'G' | 'g' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:799:10: ( 'H' | 'h' ) ( 'A' | 'a' ) ( 'V' | 'v' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'G' | 'g' )
            {
            if ( input.LA(1)=='H'||input.LA(1)=='h' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mUNDEF() throws RecognitionException {
        try {
            int _type = UNDEF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:801:7: ( ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'F' | 'f' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:801:9: ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'E' | 'e' ) ( 'F' | 'f' )
            {
            if ( input.LA(1)=='U'||input.LA(1)=='u' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mBINDINGS() throws RecognitionException {
        try {
            int _type = BINDINGS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:803:10: ( ( 'B' | 'b' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'G' | 'g' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:803:12: ( 'B' | 'b' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'G' | 'g' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSERVICE() throws RecognitionException {
        try {
            int _type = SERVICE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:805:9: ( ( 'S' | 's' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'V' | 'v' ) ( 'I' | 'i' ) ( 'C' | 'c' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:805:11: ( 'S' | 's' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'V' | 'v' ) ( 'I' | 'i' ) ( 'C' | 'c' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mBIND() throws RecognitionException {
        try {
            int _type = BIND;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:807:6: ( ( 'B' | 'b' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:807:8: ( 'B' | 'b' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mMINUS_KEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:809:15: ( ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:809:17: ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='M'||input.LA(1)=='m' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mIRI() throws RecognitionException {
        try {
            int _type = IRI;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:811:5: ( ( 'I' | 'i' ) ( 'R' | 'r' ) ( 'I' | 'i' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:811:7: ( 'I' | 'i' ) ( 'R' | 'r' ) ( 'I' | 'i' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mURI() throws RecognitionException {
        try {
            int _type = URI;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:813:5: ( ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'I' | 'i' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:813:7: ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'I' | 'i' )
            {
            if ( input.LA(1)=='U'||input.LA(1)=='u' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mBNODE() throws RecognitionException {
        try {
            int _type = BNODE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:815:7: ( ( 'B' | 'b' ) ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'D' | 'd' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:815:9: ( 'B' | 'b' ) ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'D' | 'd' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mRAND() throws RecognitionException {
        try {
            int _type = RAND;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:817:6: ( ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:817:8: ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='R'||input.LA(1)=='r' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mABS() throws RecognitionException {
        try {
            int _type = ABS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:819:4: ( ( 'A' | 'a' ) ( 'B' | 'b' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:819:6: ( 'A' | 'a' ) ( 'B' | 'b' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCEIL() throws RecognitionException {
        try {
            int _type = CEIL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:821:6: ( ( 'C' | 'c' ) ( 'E' | 'e' ) ( 'I' | 'i' ) ( 'L' | 'l' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:821:8: ( 'C' | 'c' ) ( 'E' | 'e' ) ( 'I' | 'i' ) ( 'L' | 'l' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mFLOOR() throws RecognitionException {
        try {
            int _type = FLOOR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:823:7: ( ( 'F' | 'f' ) ( 'L' | 'l' ) ( 'O' | 'o' ) ( 'O' | 'o' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:823:9: ( 'F' | 'f' ) ( 'L' | 'l' ) ( 'O' | 'o' ) ( 'O' | 'o' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='F'||input.LA(1)=='f' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mROUND() throws RecognitionException {
        try {
            int _type = ROUND;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:825:7: ( ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'D' | 'd' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:825:9: ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'D' | 'd' )
            {
            if ( input.LA(1)=='R'||input.LA(1)=='r' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCONCAT() throws RecognitionException {
        try {
            int _type = CONCAT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:827:9: ( ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:827:11: ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSTRLEN() throws RecognitionException {
        try {
            int _type = STRLEN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:829:8: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'N' | 'n' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:829:10: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'N' | 'n' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mUCASE() throws RecognitionException {
        try {
            int _type = UCASE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:831:7: ( ( 'U' | 'u' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:831:9: ( 'U' | 'u' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='U'||input.LA(1)=='u' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mLCASE() throws RecognitionException {
        try {
            int _type = LCASE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:833:7: ( ( 'L' | 'l' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:833:9: ( 'L' | 'l' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='L'||input.LA(1)=='l' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mENCODE_FOR_URI() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:835:16: ( ( 'E' | 'e' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'D' | 'd' ) ( 'E' | 'e' ) '_' ( 'F' | 'f' ) ( 'O' | 'o' ) ( 'R' | 'r' ) '_' ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'I' | 'i' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:835:18: ( 'E' | 'e' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'D' | 'd' ) ( 'E' | 'e' ) '_' ( 'F' | 'f' ) ( 'O' | 'o' ) ( 'R' | 'r' ) '_' ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'I' | 'i' )
            {
            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCONTAINS() throws RecognitionException {
        try {
            int _type = CONTAINS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:837:10: ( ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'T' | 't' ) ( 'A' | 'a' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:837:12: ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'T' | 't' ) ( 'A' | 'a' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSTRSTARTS() throws RecognitionException {
        try {
            int _type = STRSTARTS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:839:11: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'A' | 'a' ) ( 'R' | 'r' ) ( 'T' | 't' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:839:13: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'A' | 'a' ) ( 'R' | 'r' ) ( 'T' | 't' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSTRENDS() throws RecognitionException {
        try {
            int _type = STRENDS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:841:9: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:841:11: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSTRBEFORE() throws RecognitionException {
        try {
            int _type = STRBEFORE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:843:11: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'B' | 'b' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'O' | 'o' ) ( 'R' | 'r' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:843:13: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'B' | 'b' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'O' | 'o' ) ( 'R' | 'r' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSTRAFTER() throws RecognitionException {
        try {
            int _type = STRAFTER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:845:10: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'F' | 'f' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:845:12: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'F' | 'f' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mREPLACE() throws RecognitionException {
        try {
            int _type = REPLACE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:847:9: ( ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'P' | 'p' ) ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'C' | 'c' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:847:11: ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'P' | 'p' ) ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'C' | 'c' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='R'||input.LA(1)=='r' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mYEAR() throws RecognitionException {
        try {
            int _type = YEAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:849:6: ( ( 'Y' | 'y' ) ( 'E' | 'e' ) ( 'A' | 'a' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:849:8: ( 'Y' | 'y' ) ( 'E' | 'e' ) ( 'A' | 'a' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='Y'||input.LA(1)=='y' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mMONTH() throws RecognitionException {
        try {
            int _type = MONTH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:851:7: ( ( 'M' | 'm' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'T' | 't' ) ( 'H' | 'h' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:851:9: ( 'M' | 'm' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'T' | 't' ) ( 'H' | 'h' )
            {
            if ( input.LA(1)=='M'||input.LA(1)=='m' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mDAY() throws RecognitionException {
        try {
            int _type = DAY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:853:5: ( ( 'D' | 'd' ) ( 'A' | 'a' ) ( 'Y' | 'y' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:853:7: ( 'D' | 'd' ) ( 'A' | 'a' ) ( 'Y' | 'y' )
            {
            if ( input.LA(1)=='D'||input.LA(1)=='d' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mHOURS() throws RecognitionException {
        try {
            int _type = HOURS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:855:7: ( ( 'H' | 'h' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:855:9: ( 'H' | 'h' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'R' | 'r' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='H'||input.LA(1)=='h' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mMINUTES() throws RecognitionException {
        try {
            int _type = MINUTES;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:857:9: ( ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:857:11: ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'T' | 't' ) ( 'E' | 'e' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='M'||input.LA(1)=='m' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSECONDS() throws RecognitionException {
        try {
            int _type = SECONDS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:859:9: ( ( 'S' | 's' ) ( 'E' | 'e' ) ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:859:11: ( 'S' | 's' ) ( 'E' | 'e' ) ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'D' | 'd' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mTIMEZONE() throws RecognitionException {
        try {
            int _type = TIMEZONE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:861:10: ( ( 'T' | 't' ) ( 'I' | 'i' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'Z' | 'z' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:861:13: ( 'T' | 't' ) ( 'I' | 'i' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'Z' | 'z' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='T'||input.LA(1)=='t' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mTZ() throws RecognitionException {
        try {
            int _type = TZ;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:863:4: ( ( 'T' | 't' ) ( 'Z' | 'z' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:863:6: ( 'T' | 't' ) ( 'Z' | 'z' )
            {
            if ( input.LA(1)=='T'||input.LA(1)=='t' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mNOW() throws RecognitionException {
        try {
            int _type = NOW;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:865:5: ( ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'W' | 'w' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:865:7: ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'W' | 'w' )
            {
            if ( input.LA(1)=='N'||input.LA(1)=='n' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mMD5() throws RecognitionException {
        try {
            int _type = MD5;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:867:5: ( ( 'M' | 'm' ) ( 'D' | 'd' ) '5' )
            // com\\googlecode\\sparkleg\\Sparql.g:867:7: ( 'M' | 'm' ) ( 'D' | 'd' ) '5'
            {
            if ( input.LA(1)=='M'||input.LA(1)=='m' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSHA1() throws RecognitionException {
        try {
            int _type = SHA1;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:869:6: ( ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '1' )
            // com\\googlecode\\sparkleg\\Sparql.g:869:8: ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '1'
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSHA224() throws RecognitionException {
        try {
            int _type = SHA224;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:871:8: ( ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '224' )
            // com\\googlecode\\sparkleg\\Sparql.g:871:10: ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '224'
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSHA256() throws RecognitionException {
        try {
            int _type = SHA256;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:873:8: ( ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '256' )
            // com\\googlecode\\sparkleg\\Sparql.g:873:10: ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '256'
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSHA384() throws RecognitionException {
        try {
            int _type = SHA384;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:875:8: ( ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '384' )
            // com\\googlecode\\sparkleg\\Sparql.g:875:10: ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '384'
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSHA512() throws RecognitionException {
        try {
            int _type = SHA512;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:877:8: ( ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '512' )
            // com\\googlecode\\sparkleg\\Sparql.g:877:10: ( 'S' | 's' ) ( 'H' | 'h' ) ( 'A' | 'a' ) '512'
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCOALESCE() throws RecognitionException {
        try {
            int _type = COALESCE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:879:10: ( ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'S' | 's' ) ( 'C' | 'c' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:879:12: ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'E' | 'e' ) ( 'S' | 's' ) ( 'C' | 'c' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mIF() throws RecognitionException {
        try {
            int _type = IF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:881:4: ( ( 'I' | 'i' ) ( 'F' | 'f' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:881:6: ( 'I' | 'i' ) ( 'F' | 'f' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSTRLANG() throws RecognitionException {
        try {
            int _type = STRLANG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:883:9: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'G' | 'g' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:883:11: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'L' | 'l' ) ( 'A' | 'a' ) ( 'N' | 'n' ) ( 'G' | 'g' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSTRDT() throws RecognitionException {
        try {
            int _type = STRDT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:885:7: ( ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'D' | 'd' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:885:9: ( 'S' | 's' ) ( 'T' | 't' ) ( 'R' | 'r' ) ( 'D' | 'd' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mISNUMERIC() throws RecognitionException {
        try {
            int _type = ISNUMERIC;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:887:11: ( ( 'I' | 'i' ) ( 'S' | 's' ) ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'I' | 'i' ) ( 'C' | 'c' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:887:13: ( 'I' | 'i' ) ( 'S' | 's' ) ( 'N' | 'n' ) ( 'U' | 'u' ) ( 'M' | 'm' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'I' | 'i' ) ( 'C' | 'c' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mCOUNT() throws RecognitionException {
        try {
            int _type = COUNT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:889:7: ( ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:889:9: ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'N' | 'n' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='C'||input.LA(1)=='c' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSUM() throws RecognitionException {
        try {
            int _type = SUM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:891:5: ( ( 'S' | 's' ) ( 'U' | 'u' ) ( 'M' | 'm' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:891:7: ( 'S' | 's' ) ( 'U' | 'u' ) ( 'M' | 'm' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mMIN() throws RecognitionException {
        try {
            int _type = MIN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:893:5: ( ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'N' | 'n' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:893:7: ( 'M' | 'm' ) ( 'I' | 'i' ) ( 'N' | 'n' )
            {
            if ( input.LA(1)=='M'||input.LA(1)=='m' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mMAX() throws RecognitionException {
        try {
            int _type = MAX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:895:5: ( ( 'M' | 'm' ) ( 'A' | 'a' ) ( 'X' | 'x' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:895:7: ( 'M' | 'm' ) ( 'A' | 'a' ) ( 'X' | 'x' )
            {
            if ( input.LA(1)=='M'||input.LA(1)=='m' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mAVG() throws RecognitionException {
        try {
            int _type = AVG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:897:5: ( ( 'A' | 'a' ) ( 'V' | 'v' ) ( 'G' | 'g' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:897:7: ( 'A' | 'a' ) ( 'V' | 'v' ) ( 'G' | 'g' )
            {
            if ( input.LA(1)=='A'||input.LA(1)=='a' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSAMPLE() throws RecognitionException {
        try {
            int _type = SAMPLE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:899:8: ( ( 'S' | 's' ) ( 'A' | 'a' ) ( 'M' | 'm' ) ( 'P' | 'p' ) ( 'L' | 'l' ) ( 'E' | 'e' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:899:10: ( 'S' | 's' ) ( 'A' | 'a' ) ( 'M' | 'm' ) ( 'P' | 'p' ) ( 'L' | 'l' ) ( 'E' | 'e' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mGROUP_CONCAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:901:15: ( ( 'G' | 'g' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'P' | 'p' ) '_' ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:901:18: ( 'G' | 'g' ) ( 'R' | 'r' ) ( 'O' | 'o' ) ( 'U' | 'u' ) ( 'P' | 'p' ) '_' ( 'C' | 'c' ) ( 'O' | 'o' ) ( 'N' | 'n' ) ( 'C' | 'c' ) ( 'A' | 'a' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='G'||input.LA(1)=='g' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mNOT() throws RecognitionException {
        try {
            int _type = NOT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:903:5: ( ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'T' | 't' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:903:7: ( 'N' | 'n' ) ( 'O' | 'o' ) ( 'T' | 't' )
            {
            if ( input.LA(1)=='N'||input.LA(1)=='n' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mIN() throws RecognitionException {
        try {
            int _type = IN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:905:4: ( ( 'I' | 'i' ) ( 'N' | 'n' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:905:6: ( 'I' | 'i' ) ( 'N' | 'n' )
            {
            if ( input.LA(1)=='I'||input.LA(1)=='i' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mEXISTS() throws RecognitionException {
        try {
            int _type = EXISTS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:907:8: ( ( 'E' | 'e' ) ( 'X' | 'x' ) ( 'I' | 'i' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'S' | 's' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:907:10: ( 'E' | 'e' ) ( 'X' | 'x' ) ( 'I' | 'i' ) ( 'S' | 's' ) ( 'T' | 't' ) ( 'S' | 's' )
            {
            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mSEPARATOR() throws RecognitionException {
        try {
            int _type = SEPARATOR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:909:11: ( ( 'S' | 's' ) ( 'E' | 'e' ) ( 'P' | 'p' ) ( 'A' | 'a' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'O' | 'o' ) ( 'R' | 'r' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:909:13: ( 'S' | 's' ) ( 'E' | 'e' ) ( 'P' | 'p' ) ( 'A' | 'a' ) ( 'R' | 'r' ) ( 'A' | 'a' ) ( 'T' | 't' ) ( 'O' | 'o' ) ( 'R' | 'r' )
            {
            if ( input.LA(1)=='S'||input.LA(1)=='s' ) {
                input.consume();
                state.failed=false;
    ...
    public final void mPNAME_NS() throws RecognitionException {
        try {
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:911:10: ( (p= PN_PREFIX )? ':' )
            // com\\googlecode\\sparkleg\\Sparql.g:911:12: (p= PN_PREFIX )? ':'
            {
            // com\\googlecode\\sparkleg\\Sparql.g:911:13: (p= PN_PREFIX )?
            int alt2=2;
    ...
    public final void mPNAME_LN() throws RecognitionException {
        try {
            int _type = PNAME_LN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:913:10: ( PNAME_NS PN_LOCAL )
            // com\\googlecode\\sparkleg\\Sparql.g:913:12: PNAME_NS PN_LOCAL
            {
    ...
    public final void mBLANK_NODE_LABEL() throws RecognitionException {
        try {
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:915:18: ( '_:' t= PN_LOCAL )
            // com\\googlecode\\sparkleg\\Sparql.g:915:20: '_:' t= PN_LOCAL
            {
            match("_:"); if (state.failed) return ;
    ...
    public final void mVAR1() throws RecognitionException {
        try {
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:917:6: ( QUESTION_MARK v= VARNAME )
            // com\\googlecode\\sparkleg\\Sparql.g:917:8: QUESTION_MARK v= VARNAME
            {
    ...
    public final void mVAR2() throws RecognitionException {
        try {
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:919:6: ( '$' v= VARNAME )
            // com\\googlecode\\sparkleg\\Sparql.g:919:8: '$' v= VARNAME
            {
            match('$'); if (state.failed) return ;
    ...
    public final void mLANGTAG() throws RecognitionException {
        try {
            int _type = LANGTAG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:921:9: ( '@' ( 'A' .. 'Z' | 'a' .. 'z' )+ ( MINUS ( 'A' .. 'Z' | 'a' .. 'z' | DIGIT )+ )* )
            // com\\googlecode\\sparkleg\\Sparql.g:921:11: '@' ( 'A' .. 'Z' | 'a' .. 'z' )+ ( MINUS ( 'A' .. 'Z' | 'a' .. 'z' | DIGIT )+ )*
            {
            match('@'); if (state.failed) return ;

            // com\\googlecode\\sparkleg\\Sparql.g:921:15: ( 'A' .. 'Z' | 'a' .. 'z' )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:921:36: ( MINUS ( 'A' .. 'Z' | 'a' .. 'z' | DIGIT )+ )*
            loop5:
            do {
                int alt5=2;
                switch ( input.LA(1) ) {
                ...
                switch (alt5) {
            	case 1 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:921:37: MINUS ( 'A' .. 'Z' | 'a' .. 'z' | DIGIT )+
            	    {
            	    mMINUS(); if (state.failed) return ;


            	    // com\\googlecode\\sparkleg\\Sparql.g:921:43: ( 'A' .. 'Z' | 'a' .. 'z' | DIGIT )+
            	    int cnt4=0;
            	    loop4:
            	    do {
            	        int alt4=2;
    ...
    public final void mINTEGER() throws RecognitionException {
        try {
            int _type = INTEGER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:923:9: ( ( DIGIT )+ )
            // com\\googlecode\\sparkleg\\Sparql.g:923:11: ( DIGIT )+
            {
            // com\\googlecode\\sparkleg\\Sparql.g:923:11: ( DIGIT )+
            int cnt6=0;
            loop6:
    ...
    public final void mDECIMAL() throws RecognitionException {
        try {
            int _type = DECIMAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:926:5: ( ( DIGIT )+ DOT ( DIGIT )* | DOT ( DIGIT )+ )
            int alt10=2;
            switch ( input.LA(1) ) {
            case '0':
            case '1':
            ...
            switch (alt10) {
                case 1 :
                    // com\\googlecode\\sparkleg\\Sparql.g:926:7: ( DIGIT )+ DOT ( DIGIT )*
                    {
                    // com\\googlecode\\sparkleg\\Sparql.g:926:7: ( DIGIT )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
                    ...
                    // com\\googlecode\\sparkleg\\Sparql.g:926:18: ( DIGIT )*
                    loop8:
                    do {
                        int alt8=2;
                        switch ( input.LA(1) ) {
                    ...
                    break;
                case 2 :
                    // com\\googlecode\\sparkleg\\Sparql.g:927:7: DOT ( DIGIT )+
                    {
                    mDOT(); if (state.failed) return ;


                    // com\\googlecode\\sparkleg\\Sparql.g:927:11: ( DIGIT )+
                    int cnt9=0;
                    loop9:
                    do {
                        int alt9=2;
    ...
    public final void mDOUBLE() throws RecognitionException {
        try {
            int _type = DOUBLE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:931:5: ( ( DIGIT )+ DOT ( DIGIT )* EXPONENT | DOT ( DIGIT )+ EXPONENT | ( DIGIT )+ EXPONENT )
            int alt15=3;
            alt15 = dfa15.predict(input);
            switch (alt15) {
                case 1 :
                    // com\\googlecode\\sparkleg\\Sparql.g:931:7: ( DIGIT )+ DOT ( DIGIT )* EXPONENT
                    {
                    // com\\googlecode\\sparkleg\\Sparql.g:931:7: ( DIGIT )+
                    int cnt11=0;
                    loop11:
                    do {
                        int alt11=2;
                    ...
                    // com\\googlecode\\sparkleg\\Sparql.g:931:18: ( DIGIT )*
                    loop12:
                    do {
                        int alt12=2;
                        switch ( input.LA(1) ) {
                    ...
                    break;
                case 2 :
                    // com\\googlecode\\sparkleg\\Sparql.g:932:7: DOT ( DIGIT )+ EXPONENT
                    {
                    mDOT(); if (state.failed) return ;


                    // com\\googlecode\\sparkleg\\Sparql.g:932:11: ( DIGIT )+
                    int cnt13=0;
                    loop13:
                    do {
                        int alt13=2;
                    ...
                    break;
                case 3 :
                    // com\\googlecode\\sparkleg\\Sparql.g:933:7: ( DIGIT )+ EXPONENT
                    {
                    // com\\googlecode\\sparkleg\\Sparql.g:933:7: ( DIGIT )+
                    int cnt14=0;
                    loop14:
                    do {
                        int alt14=2;
    ...
    public final void mINTEGER_POSITIVE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:936:18: ( PLUS INTEGER )
            // com\\googlecode\\sparkleg\\Sparql.g:936:20: PLUS INTEGER
            {
    ...
    public final void mDECIMAL_POSITIVE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:938:18: ( PLUS DECIMAL )
            // com\\googlecode\\sparkleg\\Sparql.g:938:20: PLUS DECIMAL
            {
            mPLUS(); if (state.failed) return ;
    ...
    public final void mDOUBLE_POSITIVE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:940:17: ( PLUS DOUBLE )
            // com\\googlecode\\sparkleg\\Sparql.g:940:19: PLUS DOUBLE
            {
            mPLUS(); if (state.failed) return ;
    ...
    public final void mINTEGER_NEGATIVE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:942:18: ( MINUS INTEGER )
            // com\\googlecode\\sparkleg\\Sparql.g:942:20: MINUS INTEGER
            {
            mMINUS(); if (state.failed) return ;
    ...
    public final void mDECIMAL_NEGATIVE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:944:18: ( MINUS DECIMAL )
            // com\\googlecode\\sparkleg\\Sparql.g:944:20: MINUS DECIMAL
            {
            mMINUS(); if (state.failed) return ;
    ...
    public final void mDOUBLE_NEGATIVE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:946:17: ( MINUS DOUBLE )
            // com\\googlecode\\sparkleg\\Sparql.g:946:19: MINUS DOUBLE
            {
            mMINUS(); if (state.failed) return ;
    ...
    public final void mEXPONENT() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:950:10: ( ( 'e' | 'E' ) ( SIGN )? ( DIGIT )+ )
            // com\\googlecode\\sparkleg\\Sparql.g:950:12: ( 'e' | 'E' ) ( SIGN )? ( DIGIT )+
            {
            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                input.consume();
                state.failed=false;
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:950:22: ( SIGN )?
            int alt16=2;
            switch ( input.LA(1) ) {
                case '+':
                case '-':
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:950:28: ( DIGIT )+
            int cnt17=0;
            loop17:
            do {
                int alt17=2;
    ...
    public final void mSTRING_LITERAL1() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:951:17: ( '\\'' ( options {greedy=false; } :~ ( '\\'' | '\\\\' | EOL ) | ECHAR )* '\\'' )
            // com\\googlecode\\sparkleg\\Sparql.g:951:19: '\\'' ( options {greedy=false; } :~ ( '\\'' | '\\\\' | EOL ) | ECHAR )* '\\''
            {
            match('\''); if (state.failed) return ;

            // com\\googlecode\\sparkleg\\Sparql.g:951:24: ( options {greedy=false; } :~ ( '\\'' | '\\\\' | EOL ) | ECHAR )*
            loop18:
            do {
                int alt18=3;
                ...
                switch (alt18) {
            	case 1 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:951:51: ~ ( '\\'' | '\\\\' | EOL )
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:951:74: ECHAR
            	    {
    ...
    public final void mSTRING_LITERAL2() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:953:17: ( '\"' ( options {greedy=false; } :~ ( '\"' | '\\\\' | EOL ) | ECHAR )* '\"' )
            // com\\googlecode\\sparkleg\\Sparql.g:953:19: '\"' ( options {greedy=false; } :~ ( '\"' | '\\\\' | EOL ) | ECHAR )* '\"'
            {
            match('\"'); if (state.failed) return ;

            // com\\googlecode\\sparkleg\\Sparql.g:953:23: ( options {greedy=false; } :~ ( '\"' | '\\\\' | EOL ) | ECHAR )*
            loop19:
            do {
                int alt19=3;
                ...
                switch (alt19) {
            	case 1 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:953:50: ~ ( '\"' | '\\\\' | EOL )
            	    {
            	    if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '\t')||(input.LA(1) >= '\u000B' && input.LA(1) <= '\f')||(input.LA(1) >= '\u000E' && input.LA(1) <= '!')||(input.LA(1) >= '#' && input.LA(1) <= '[')||(input.LA(1) >= ']' && input.LA(1) <= '\uFFFF') ) {
            	        input.consume();
            	        state.failed=false;
            	    ...
            	    break;
            	case 2 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:953:72: ECHAR
            	    {
            	    mECHAR(); if (state.failed) return ;
    ...
    public final void mSTRING_LITERAL_LONG1() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:955:22: ( '\\'\\'\\'' ( options {greedy=false; } : ( '\\'' | '\\'\\'' )? (~ ( '\\'' | '\\\\' ) | ECHAR ) )* '\\'\\'\\'' )
            // com\\googlecode\\sparkleg\\Sparql.g:955:24: '\\'\\'\\'' ( options {greedy=false; } : ( '\\'' | '\\'\\'' )? (~ ( '\\'' | '\\\\' ) | ECHAR ) )* '\\'\\'\\''
            {
            match("'''"); if (state.failed) return ;



            // com\\googlecode\\sparkleg\\Sparql.g:955:33: ( options {greedy=false; } : ( '\\'' | '\\'\\'' )? (~ ( '\\'' | '\\\\' ) | ECHAR ) )*
            loop22:
            do {
                int alt22=2;
                ...
                switch (alt22) {
            	case 1 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:955:60: ( '\\'' | '\\'\\'' )? (~ ( '\\'' | '\\\\' ) | ECHAR )
            	    {
            	    // com\\googlecode\\sparkleg\\Sparql.g:955:60: ( '\\'' | '\\'\\'' )?
            	    int alt20=3;
            	    switch ( input.LA(1) ) {
            	        case '\'':
            	            {
            	    ...
            	    switch (alt20) {
            	        case 1 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:955:61: '\\''
            	            {
            	            match('\''); if (state.failed) return ;
            	            ...
            	            break;
            	        case 2 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:955:68: '\\'\\''
            	            {
            	            match("''"); if (state.failed) return ;
            	    ...
            	    // com\\googlecode\\sparkleg\\Sparql.g:955:77: (~ ( '\\'' | '\\\\' ) | ECHAR )
            	    int alt21=2;
            	    ...
            	    switch (alt21) {
            	        case 1 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:955:78: ~ ( '\\'' | '\\\\' )
            	            {
            	            ...
            	            break;
            	        case 2 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:955:93: ECHAR
            	            {
            	            mECHAR(); if (state.failed) return ;
    ...
    public final void mSTRING_LITERAL_LONG2() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:957:22: ( '\"\"\"' ( options {greedy=false; } : ( '\"' | '\"\"' )? (~ ( '\"' | '\\\\' ) | ECHAR ) )* '\"\"\"' )
            // com\\googlecode\\sparkleg\\Sparql.g:957:24: '\"\"\"' ( options {greedy=false; } : ( '\"' | '\"\"' )? (~ ( '\"' | '\\\\' ) | ECHAR ) )* '\"\"\"'
            {
            match("\"\"\""); if (state.failed) return ;



            // com\\googlecode\\sparkleg\\Sparql.g:957:30: ( options {greedy=false; } : ( '\"' | '\"\"' )? (~ ( '\"' | '\\\\' ) | ECHAR ) )*
            loop25:
            do {
                int alt25=2;
                ...
                switch (alt25) {
            	case 1 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:957:57: ( '\"' | '\"\"' )? (~ ( '\"' | '\\\\' ) | ECHAR )
            	    {
            	    // com\\googlecode\\sparkleg\\Sparql.g:957:57: ( '\"' | '\"\"' )?
            	    int alt23=3;
            	    switch ( input.LA(1) ) {
            	        case '\"':
            	            {
            	    ...
            	    switch (alt23) {
            	        case 1 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:957:58: '\"'
            	            {
            	            match('\"'); if (state.failed) return ;
            	            ...
            	            break;
            	        case 2 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:957:64: '\"\"'
            	            {
            	            match("\"\""); if (state.failed) return ;
            	    ...
            	    // com\\googlecode\\sparkleg\\Sparql.g:957:71: (~ ( '\"' | '\\\\' ) | ECHAR )
            	    int alt24=2;
            	    ...
            	    switch (alt24) {
            	        case 1 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:957:72: ~ ( '\"' | '\\\\' )
            	            {
            	            if ( (input.LA(1) >= '\u0000' && input.LA(1) <= '!')||(input.LA(1) >= '#' && input.LA(1) <= '[')||(input.LA(1) >= ']' && input.LA(1) <= '\uFFFF') ) {
            	                input.consume();
            	                state.failed=false;
            	            ...
            	            break;
            	        case 2 :
            	            // com\\googlecode\\sparkleg\\Sparql.g:957:86: ECHAR
            	            {
            	            mECHAR(); if (state.failed) return ;
    ...
    public final void mECHAR() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:961:7: ( '\\\\' ( 't' | 'b' | 'n' | 'r' | 'f' | '\\\\' | '\"' | '\\'' ) )
            // com\\googlecode\\sparkleg\\Sparql.g:961:9: '\\\\' ( 't' | 'b' | 'n' | 'r' | 'f' | '\\\\' | '\"' | '\\'' )
            {
            match('\\'); if (state.failed) return ;
    ...
    public final void mIRI_REF() throws RecognitionException {
        try {
            int _type = IRI_REF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:963:5: ( ( LESS ( options {greedy=false; } : IRI_REF_CHARACTERS )* GREATER )=> LESS ( options {greedy=false; } : IRI_REF_CHARACTERS )* GREATER | LESS )
            int alt27=2;
            switch ( input.LA(1) ) {
            case '<':
                {
            ...
            switch (alt27) {
                case 1 :
                    // com\\googlecode\\sparkleg\\Sparql.g:963:6: ( LESS ( options {greedy=false; } : IRI_REF_CHARACTERS )* GREATER )=> LESS ( options {greedy=false; } : IRI_REF_CHARACTERS )* GREATER
                    {
                    mLESS(); if (state.failed) return ;


                    // com\\googlecode\\sparkleg\\Sparql.g:963:76: ( options {greedy=false; } : IRI_REF_CHARACTERS )*
                    loop26:
                    do {
                        int alt26=2;
                        ...
                        switch (alt26) {
                    	case 1 :
                    	    // com\\googlecode\\sparkleg\\Sparql.g:963:101: IRI_REF_CHARACTERS
                    	    {
                    ...
                    break;
                case 2 :
                    // com\\googlecode\\sparkleg\\Sparql.g:964:7: LESS
                    {
                    mLESS(); if (state.failed) return ;
    ...
    public final void mIRI_REF_CHARACTERS() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:970:5: (~ ( LESS | GREATER | '\"' | OPEN_CURLY_BRACE | CLOSE_CURLY_BRACE | PIPE | INVERSE | '`' | '\\\\' | ( '\\u0000' .. '\\u0020' ) ) )
            // com\\googlecode\\sparkleg\\Sparql.g:
            {
    ...
    public final void mPN_CHARS_U() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:974:12: ( PN_CHARS_BASE | '_' )
            // com\\googlecode\\sparkleg\\Sparql.g:
            {
    ...
    public final void mVARNAME() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:977:9: ( ( PN_CHARS_U | DIGIT ) ( PN_CHARS_U | DIGIT | '\\u00B7' | '\\u0300' .. '\\u036F' | '\\u203F' .. '\\u2040' )* )
            // com\\googlecode\\sparkleg\\Sparql.g:977:11: ( PN_CHARS_U | DIGIT ) ( PN_CHARS_U | DIGIT | '\\u00B7' | '\\u0300' .. '\\u036F' | '\\u203F' .. '\\u2040' )*
            {
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:977:32: ( PN_CHARS_U | DIGIT | '\\u00B7' | '\\u0300' .. '\\u036F' | '\\u203F' .. '\\u2040' )*
            loop28:
            do {
                int alt28=2;
    ...
    public final void mPN_CHARS() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:981:5: ( PN_CHARS_U | MINUS | DIGIT | '\\u00B7' | '\\u0300' .. '\\u036F' | '\\u203F' .. '\\u2040' )
            // com\\googlecode\\sparkleg\\Sparql.g:
            {
    ...
    public final void mPN_PREFIX() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:990:11: ( PN_CHARS_BASE ( ( PN_CHARS | DOT )* PN_CHARS )? )
            // com\\googlecode\\sparkleg\\Sparql.g:990:13: PN_CHARS_BASE ( ( PN_CHARS | DOT )* PN_CHARS )?
            {
            mPN_CHARS_BASE(); if (state.failed) return ;


            // com\\googlecode\\sparkleg\\Sparql.g:990:27: ( ( PN_CHARS | DOT )* PN_CHARS )?
            int alt30=2;
            ...
            switch (alt30) {
                case 1 :
                    // com\\googlecode\\sparkleg\\Sparql.g:990:28: ( PN_CHARS | DOT )* PN_CHARS
                    {
                    // com\\googlecode\\sparkleg\\Sparql.g:990:28: ( PN_CHARS | DOT )*
                    loop29:
                    do {
                        int alt29=2;
    ...
    public final void mPN_LOCAL() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:993:10: ( ( PN_CHARS_U | DIGIT ) ( ( PN_CHARS | DOT )* PN_CHARS )? )
            // com\\googlecode\\sparkleg\\Sparql.g:993:12: ( PN_CHARS_U | DIGIT ) ( ( PN_CHARS | DOT )* PN_CHARS )?
            {
            if ( (input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= 'A' && input.LA(1) <= 'Z')||input.LA(1)=='_'||(input.LA(1) >= 'a' && input.LA(1) <= 'z')||(input.LA(1) >= '\u00C0' && input.LA(1) <= '\u00D6')||(input.LA(1) >= '\u00D8' && input.LA(1) <= '\u00F6')||(input.LA(1) >= '\u00F8' && input.LA(1) <= '\u02FF')||(input.LA(1) >= '\u0370' && input.LA(1) <= '\u037D')||(input.LA(1) >= '\u037F' && input.LA(1) <= '\u1FFF')||(input.LA(1) >= '\u200C' && input.LA(1) <= '\u200D')||(input.LA(1) >= '\u2070' && input.LA(1) <= '\u218F')||(input.LA(1) >= '\u2C00' && input.LA(1) <= '\u2FEF')||(input.LA(1) >= '\u3001' && input.LA(1) <= '\uD7FF')||(input.LA(1) >= '\uF900' && input.LA(1) <= '\uFDCF')||(input.LA(1) >= '\uFDF0' && input.LA(1) <= '\uFFFD') ) {
                input.consume();
                state.failed=false;
            ...
            // com\\googlecode\\sparkleg\\Sparql.g:993:32: ( ( PN_CHARS | DOT )* PN_CHARS )?
            int alt32=2;
            ...
            switch (alt32) {
                case 1 :
                    // com\\googlecode\\sparkleg\\Sparql.g:993:33: ( PN_CHARS | DOT )* PN_CHARS
                    {
                    // com\\googlecode\\sparkleg\\Sparql.g:993:33: ( PN_CHARS | DOT )*
                    loop31:
                    do {
                        int alt31=3;
                        ...
                        switch (alt31) {
                    	case 1 :
                    	    // com\\googlecode\\sparkleg\\Sparql.g:993:34: PN_CHARS
                    	    {
                    	    mPN_CHARS(); if (state.failed) return ;
                    	    ...
                    	    break;
                    	case 2 :
                    	    // com\\googlecode\\sparkleg\\Sparql.g:993:43: DOT
                    	    {
    ...
    public final void mPN_CHARS_BASE() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:1004:5: ( 'A' .. 'Z' | 'a' .. 'z' | '\\u00C0' .. '\\u00D6' | '\\u00D8' .. '\\u00F6' | '\\u00F8' .. '\\u02FF' | '\\u0370' .. '\\u037D' | '\\u037F' .. '\\u1FFF' | '\\u200C' .. '\\u200D' | '\\u2070' .. '\\u218F' | '\\u2C00' .. '\\u2FEF' | '\\u3001' .. '\\uD7FF' | '\\uF900' .. '\\uFDCF' | '\\uFDF0' .. '\\uFFFD' )
            // com\\googlecode\\sparkleg\\Sparql.g:
            {
    ...
    public final void mDIGIT() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:1020:7: ( '0' .. '9' )
            // com\\googlecode\\sparkleg\\Sparql.g:
            {
            if ( (input.LA(1) >= '0' && input.LA(1) <= '9') ) {
                input.consume();
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1021:9: ( '#' ( options {greedy=false; } : . )* EOL )
            // com\\googlecode\\sparkleg\\Sparql.g:1021:11: '#' ( options {greedy=false; } : . )* EOL
            {
            match('#'); if (state.failed) return ;

            // com\\googlecode\\sparkleg\\Sparql.g:1021:15: ( options {greedy=false; } : . )*
            loop33:
            do {
                int alt33=2;
                ...
                switch (alt33) {
            	case 1 :
            	    // com\\googlecode\\sparkleg\\Sparql.g:1021:41: .
            	    {
    ...
    public final void mEOL() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:1025:5: ( '\\n' | '\\r' )
            // com\\googlecode\\sparkleg\\Sparql.g:
            {
            if ( input.LA(1)=='\n'||input.LA(1)=='\r' ) {
                input.consume();
    ...
    public final void mREFERENCE() throws RecognitionException {
        try {
            int _type = REFERENCE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1026:11: ( '^^' )
    ...
    public final void mLESS_EQUAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1028:12: ( '<=' )
            // com\\googlecode\\sparkleg\\Sparql.g:1028:14: '<='
            {
            match("<="); if (state.failed) return ;
    ...
    public final void mGREATER_EQUAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1030:15: ( '>=' )
            // com\\googlecode\\sparkleg\\Sparql.g:1030:17: '>='
            {
            match(">="); if (state.failed) return ;
    ...
    public final void mNOT_EQUAL() throws RecognitionException {
        try {
            int _type = NOT_EQUAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1032:11: ( '!=' )
            // com\\googlecode\\sparkleg\\Sparql.g:1032:13: '!='
            {
            match("!="); if (state.failed) return ;
    ...
    public final void mAND() throws RecognitionException {
        try {
            int _type = AND;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1034:5: ( '&&' )
            // com\\googlecode\\sparkleg\\Sparql.g:1034:7: '&&'
            {
            match("&&"); if (state.failed) return ;
    ...
    public final void mOR() throws RecognitionException {
        try {
            int _type = OR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1036:4: ( '||' )
            // com\\googlecode\\sparkleg\\Sparql.g:1036:6: '||'
            {
            match("||"); if (state.failed) return ;
    ...
    public final void mINVERSE() throws RecognitionException {
        try {
            int _type = INVERSE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1038:9: ( '^' )
            // com\\googlecode\\sparkleg\\Sparql.g:1038:11: '^'
            {
            match('^'); if (state.failed) return ;
    ...
    public final void mOPEN_BRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1040:12: ( '(' )
            // com\\googlecode\\sparkleg\\Sparql.g:1040:14: '('
            {
            match('('); if (state.failed) return ;
    ...
    public final void mCLOSE_BRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1042:13: ( ')' )
            // com\\googlecode\\sparkleg\\Sparql.g:1042:15: ')'
            {
            match(')'); if (state.failed) return ;
    ...
    public final void mOPEN_CURLY_BRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1044:18: ( '{' )
            // com\\googlecode\\sparkleg\\Sparql.g:1044:20: '{'
            {
            match('{'); if (state.failed) return ;
    ...
    public final void mCLOSE_CURLY_BRACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1046:19: ( '}' )
            // com\\googlecode\\sparkleg\\Sparql.g:1046:21: '}'
            {
            match('}'); if (state.failed) return ;
    ...
    public final void mOPEN_SQUARE_BRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1048:21: ( '[' )
            // com\\googlecode\\sparkleg\\Sparql.g:1048:23: '['
            {
            match('['); if (state.failed) return ;
    ...
    public final void mCLOSE_SQUARE_BRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1050:22: ( ']' )
            // com\\googlecode\\sparkleg\\Sparql.g:1050:24: ']'
            {
            match(']'); if (state.failed) return ;
    ...
    public final void mSEMICOLON() throws RecognitionException {
        try {
            int _type = SEMICOLON;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1052:11: ( ';' )
            // com\\googlecode\\sparkleg\\Sparql.g:1052:13: ';'
            {
            match(';'); if (state.failed) return ;
    ...
    public final void mDOT() throws RecognitionException {
        try {
            int _type = DOT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1054:5: ( '.' )
            // com\\googlecode\\sparkleg\\Sparql.g:1054:7: '.'
            {
            match('.'); if (state.failed) return ;
    ...
    public final void mPLUS() throws RecognitionException {
        try {
            int _type = PLUS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1056:6: ( '+' )
            // com\\googlecode\\sparkleg\\Sparql.g:1056:8: '+'
            {
            match('+'); if (state.failed) return ;
    ...
    public final void mMINUS() throws RecognitionException {
        try {
            int _type = MINUS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1058:7: ( '-' )
            // com\\googlecode\\sparkleg\\Sparql.g:1058:9: '-'
            {
            match('-'); if (state.failed) return ;
    ...
    public final void mSIGN() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:1062:6: ( ( PLUS | MINUS ) )
            // com\\googlecode\\sparkleg\\Sparql.g:
            {
            if ( input.LA(1)=='+'||input.LA(1)=='-' ) {
                input.consume();
    ...
    public final void mASTERISK() throws RecognitionException {
        try {
            int _type = ASTERISK;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1063:10: ( '*' )
            // com\\googlecode\\sparkleg\\Sparql.g:1063:12: '*'
            {
            match('*'); if (state.failed) return ;
    ...
    public final void mQUESTION_MARK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1065:15: ( '?' )
            // com\\googlecode\\sparkleg\\Sparql.g:1065:17: '?'
            {
            match('?'); if (state.failed) return ;
    ...
    public final void mCOMMA() throws RecognitionException {
        try {
            int _type = COMMA;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1067:7: ( ',' )
            // com\\googlecode\\sparkleg\\Sparql.g:1067:9: ','
            {
            match(','); if (state.failed) return ;
    ...
    public final void mNEGATION() throws RecognitionException {
        try {
            int _type = NEGATION;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1069:10: ( '!' )
            // com\\googlecode\\sparkleg\\Sparql.g:1069:12: '!'
            {
            match('!'); if (state.failed) return ;
    ...
    public final void mDIVIDE() throws RecognitionException {
        try {
            int _type = DIVIDE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1071:8: ( '/' )
            // com\\googlecode\\sparkleg\\Sparql.g:1071:10: '/'
            {
            match('/'); if (state.failed) return ;
    ...
    public final void mEQUAL() throws RecognitionException {
        try {
            int _type = EQUAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1073:7: ( '=' )
            // com\\googlecode\\sparkleg\\Sparql.g:1073:9: '='
            {
            match('='); if (state.failed) return ;
    ...
    public final void mLESS() throws RecognitionException {
        try {
            // com\\googlecode\\sparkleg\\Sparql.g:1077:6: ( '<' )
            // com\\googlecode\\sparkleg\\Sparql.g:1077:8: '<'
            {
            match('<'); if (state.failed) return ;
    ...
    public final void mGREATER() throws RecognitionException {
        try {
            int _type = GREATER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1078:9: ( '>' )
            // com\\googlecode\\sparkleg\\Sparql.g:1078:11: '>'
            {
            match('>'); if (state.failed) return ;
    ...
    public final void mPIPE() throws RecognitionException {
        try {
            int _type = PIPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1080:6: ( '|' )
            // com\\googlecode\\sparkleg\\Sparql.g:1080:8: '|'
            {
            match('|'); if (state.failed) return ;
    ...
    public final void mANY() throws RecognitionException {
        try {
            int _type = ANY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\sparkleg\\Sparql.g:1082:5: ( . )
            // com\\googlecode\\sparkleg\\Sparql.g:1082:7: .
            {
            matchAny(); if (state.failed) return ;
    ...
    public final void synpred1_Sparql_fragment() throws RecognitionException {
        // com\\googlecode\\sparkleg\\Sparql.g:963:6: ( LESS ( options {greedy=false; } : IRI_REF_CHARACTERS )* GREATER )
        // com\\googlecode\\sparkleg\\Sparql.g:963:7: LESS ( options {greedy=false; } : IRI_REF_CHARACTERS )* GREATER
        {
        mLESS(); if (state.failed) return ;


        // com\\googlecode\\sparkleg\\Sparql.g:963:12: ( options {greedy=false; } : IRI_REF_CHARACTERS )*
        loop35:
        do {
            int alt35=2;
            ...
            switch (alt35) {
        	case 1 :
        	    // com\\googlecode\\sparkleg\\Sparql.g:963:37: IRI_REF_CHARACTERS
        	    {
        	    mIRI_REF_CHARACTERS(); if (state.failed) return ;
    ...
    class DFA15 extends DFA {
        ...
        public String getDescription() {
            return "930:1: DOUBLE : ( ( DIGIT )+ DOT ( DIGIT )* EXPONENT | DOT ( DIGIT )+ EXPONENT | ( DIGIT )+ EXPONENT );";
        }
    }
