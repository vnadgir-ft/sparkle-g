/*
 * Presumably you are already busy writing an update of your Definite ANTLR Reference
 * and it should be an easy guess which animal will depicted on the front page.
 * 
 * 
 */
